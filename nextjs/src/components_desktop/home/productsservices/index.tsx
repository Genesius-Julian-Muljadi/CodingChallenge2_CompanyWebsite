    ...
    return (
        <div className="text-center mx-20 mt-8" id="homepscontainerdiv">
            <div className="grid grid-cols-1 grid-rows-3 gap-6">
                <div className="col-start-1 row-start-1 grid grid-cols-2 grid-rows-1 gap-6 *:rounded-lg *:border *:border-slate-700">
                ...
                <div className="col-start-1 row-start-2 grid grid-cols-3 grid-rows-2 gap-6 mx-10 *:grid *:grid-cols-1 *:grid-rows-6 *:rounded *:border *:border-slate-700 text-lg font-bold font-serif" id="homejewelrytypesdiv">
                ...
                <Link href="/catalogue"
                className="col-start-1 row-start-3 mb-auto mx-auto mt-5 pl-4 pr-4 py-1 flex flex-row gap-2 rounded-lg border border-black font-mono" id="homecataloguediv">
                    <div>Catalogue</div>
                    <div>
